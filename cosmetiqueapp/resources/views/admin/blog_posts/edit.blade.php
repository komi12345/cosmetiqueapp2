                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.blog_posts.update', $blogPost) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $blogPost->title) }}" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-xl font-semibold text-gray-800 leading-snug" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="content" id="content" rows="10" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-sm text-gray-600 leading-relaxed">{{ old('content', $blogPost->content) }}</textarea>
                        </div>
